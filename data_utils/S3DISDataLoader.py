...
if __name__ == '__main__':
    ...
    root = r"C:\Users\PC\Desktop\PointNet_pytroch_77star"
    file_list = getDataFiles(os.path.join(root,'data/indoor3d_sem_seg_hdf5_data/all_files.txt'))

    data_batch, label_batch = loadDataFile(os.path.join(root,'./data/',file_list[1]))

    points = data_batch[2,:,:]  # shape = (4096,9)
    labels = label_batch[2,:]
