...
def train():
    ...
    model, optimizer = amp.initialize(model, optimizer, opt_level="O1")  # O1 not 01
    ...
    for epoch in range(start_epoch,max_epoch):
        ...
        with torch.no_grad():
            ...
            if mean_iou > best_iou:
                ...
                save_path = os.path.join('./checkpoints', "apex_eph_{}_iou_{:.2%}.ckpt.pth".format(epoch+1,best_iou))
